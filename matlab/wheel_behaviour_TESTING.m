...
function wheel_behaviour_TESTING
...
load(['E:\Data\' mouse '\' mouse '_TESTING_stimInfo.mat']) 

% add folder paths
addpath 'C:\Users\geffen-behaviour2\Documents\GitHub\Kath\FM_stimuli'
...
filename = [saveLoc mouse '_' datestr(now,'yyyy_mm_dd') '_testing.txt'];
