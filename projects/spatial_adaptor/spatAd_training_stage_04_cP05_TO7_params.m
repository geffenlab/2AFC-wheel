...
stimInfo.adaptor_level      = 30;               % mean level dB
stimInfo.adaptor_bandwidth  = [5 60];           % adaptor bandwidth in kHz
stimInfo.target_dur         = 0.5;              % target duration in s
stimInfo.target_level       = 40;               % mean level dB
stimInfo.target_ILDs        = [-80,80];         % ILD of target
stimInfo.target_bandwidth   = [5 60];           % target bandwidth in kHz
stimInfo.envDur             = 0.001;            % duration of envelope in s
...
params.rewardDuration_L = 79;
params.rewardDuration_R = 122;
params.rewardDuration_C = 11;
